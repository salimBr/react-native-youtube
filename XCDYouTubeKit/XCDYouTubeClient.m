...
- (id<XCDYouTubeOperation>) getVideoWithIdentifier:(NSString *)videoIdentifier token:(NSDictionary*)token cookies:(NSArray<NSHTTPCookie *> *)cookies completionHandler:(void (^)(XCDYouTubeVideo * _Nullable, NSError * _Nullable))completionHandler
{
    NSLog(@"entered heere with cookies = == %@",cookies);
    ...
    XCDYouTubeVideoOperation *operation = [[XCDYouTubeVideoOperation alloc] initWithVideoIdentifier:videoIdentifier  languageIdentifier:self.languageIdentifier token:token cookies:cookies];
...
{
    return [self getVideoWithIdentifier:videoIdentifier token:nil cookies:nil  completionHandler:completionHandler];
}

- (id<XCDYouTubeOperation>) getVideoWithIdentifier:(NSString *)videoIdentifier token:(NSDictionary *) token completionHandler:(void (^)(XCDYouTubeVideo * __nullable video, NSError * __nullable error))completionHandler
{
    return [self getVideoWithIdentifier:videoIdentifier token:token cookies:nil  completionHandler:completionHandler];
}
@end
